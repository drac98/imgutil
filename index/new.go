...
func NewIndex(repoName string, ops ...Option) (idx *ImageIndex, err error) {
	...
	case types.DockerManifestList:
		dockerIndex := imgutil.NewEmptyDockerIndex()
		cnbIndex, err = imgutil.NewCNBIndex(repoName, dockerIndex, *idxOps)
		if err != nil {
			return idx, err
		}
		// TODO I don't think we should write into disk during creation
		_, err = layout.Write(layoutPath, dockerIndex)
	default:
		cnbIndex, err = imgutil.NewCNBIndex(repoName, empty.Index, *idxOps)
		if err != nil {
			return idx, err
		}
		// TODO I don't think we should write into disk during creation
